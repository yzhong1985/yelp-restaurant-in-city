...
def business_name_query(category, terms, cities):
    """Queries the API by the input values from the user.
        Modified to search for multiple cities and output as one single file
    Args:
        category (str): Used for output path
...
def main():
    ...
    try:
        ...
        # Asian food
        # terms = ['chinese', 'asianfusion', 'halal', 'japanese', 'korean', 'mideastern', 'hotpot', 'indonesian',\
        #         'mongolian', 'ramen', 'sushi', 'taiwanese', 'thai', 'vietnamese', 'filipino', 'indpak', 'noodles']
        # American food
        # terms = ['american', 'bars', 'burgers', 'coffee', 'hawaiian', 'pizza', 'pubs', 'sportsbars', 'chicken_wings',\
        #         'creperies']
        # European food
        # terms = ['belgian', 'irish', 'french', 'greek', 'italian', 'mediterranean', 'portuguese', 'modern_european', \
        #         'russian', 'scottish', 'german', 'tapas']
        # Mexican food
        # terms = ['mexican']
        # Others
        ...
        # Fast food <- american
        #terms = ['McDonald', 'Burger King','Subway','Applebee','Pizza Hut','Taco Bell', 'KFC', 'Dunkin', 'Chick-fil-A', 'Panera', 'Chipotle', 'Carl', 'Little Caesars', 'Dairy Queen', 'Jack in the Box', 'Papa John']

        cities = ['Claremont', 'Ontario', 'Rancho Cucamonga', 'Upland', 'Montclair']
        # for term in terms:
        #    restaurant_query(term, cities)
        restaurant_query('others', terms, cities)
        #business_name_query('fastfoodchain', terms, cities)
